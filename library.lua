...
local Library do
    ...
    local Components = { } do
        ...
        Components.MultiKeybind = function(Data)
            local Keybind = {
                Type = "Keybind",
                IsOpen = false,
            ...
            local Items = { } do
                ...
                Items["SecondKeyButton"] = Instances:Create("TextButton", {
                    Parent = Items["KeyButton"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(255, 255, 255),
            ...
            local Update = function()
                ...
                if not Keybind.ModifierValue or not Keybind.Value then
                    return
                end

                KeylistItem:SetText(Keybind.ModifierValue .. Keybind.Value, Data.Name)
            ...
            function Keybind:Set(Key)
                if StringFind(tostring(Key), "Enum") then 
                    ...
                    Library.Flags[Data.Flag] = {
                        Mode = Keybind.Mode,
                        Key = Keybind.Key,
                        ModifierKey = Keybind.ModifierKey
                    }
            ...
            function Keybind:Set2ndKey(Key)
                if StringFind(tostring(Key), "Enum") then 
                    Keybind.ModifierKey = tostring(Key)
                    ...
                    Keybind.ModifierValue = TextToDisplay
                    Items["SecondKeyButton"].Instance.Text = TextToDisplay .. " +"
                    ...
                    if Data.Callback then 
                        Library:SafeCall(Data.Callback, Keybind.ModifierToggled)
                    end

                    Update()
                elseif type(Key) == "table" then
                    local RealKey = Key.Key == "Backspace" and "None" or Key.Key
                    Keybind.ModifierKey = tostring(Key.Key)
                ...
                Items["SecondKeyButton"]:Tween(nil, {TextTransparency = 0.5})
                Keybind.Picking = false
            end
            ...
            function Keybind:PressModifier(Bool)
                if Keybind.Mode == "toggle" then 
                    Keybind.ModifierToggled = not Keybind.ModifierToggled
                elseif Keybind.Mode == "hold" then 
                    Keybind.ModifierToggled = Bool
                elseif Keybind.Mode == "always" then 
                    Keybind.ModifierToggled = true
                end
            ...
            function Keybind:ConditionsMet()
                return Keybind.ModifierToggled == Keybind.Toggled
            end
            ...
            Items["SecondKeyButton"]:Connect("MouseButton1Click", function()
                if Keybind.Picking then 
                    return
                end
                ...
                Items["SecondKeyButton"]:Tween(nil, {TextTransparency = 0})

                local InputBegan 
                InputBegan = UserInputService.InputBegan:Connect(function(Input)
                    if Input.UserInputType == Enum.UserInputType.Keyboard then 

                        Keybind:Set2ndKey(Input.KeyCode)
                    end
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                ...
                elseif tostring(Input.KeyCode) == Keybind.ModifierKey or tostring(Input.UserInputType) == Keybind.ModifierKey and not Keybind.ModifierValue == "None" then
                    if Keybind.Mode == "toggle" then 
                        Keybind:PressModifier()
                    elseif Keybind.Mode == "hold" then 
                        Keybind:PressModifier(true)
                    end
                end
                ...
                if Keybind.ModifierToggled == true and Keybind.Toggled == true then
                    print("Fuck Nigggers!!!!!!!!!!")
                else
                    print(Keybind.ModifierToggled, Keybind.Toggled)
                end
            end)
            ...
            Library:Connect(UserInputService.InputEnded, function(Input)
                ...
                if tostring(Input.KeyCode) == Keybind.ModifierKey or tostring(Input.UserInputType) == Keybind.ModifierKey and not Keybind.ModifierValue == "None"  then
                    if Keybind.Mode == "hold" then 
                        Keybind:PressModifier(false)
                    end
                end
            end)
    ...
    do -- Element functions
        ...
        Library.Pages.MultiSection = function(self, Data)
            ...
            local Items = { } do
                Items["MultiSection"] = Instances:Create("Frame", {
                    ...
                    AutomaticSize = Enum.AutomaticSize.Y,
                    BackgroundColor3 = FromRGB(22, 25, 29)
                })  Items["MultiSection"]:AddToTheme({BackgroundColor3 = "Inline"})
            ...
            function MultiSection:NewSection(Name, Icon)
                local NewSection = {
                    Name = Name or "1",
                ...
                local SubItems = { } do
                    SubItems["Inactive"] = Instances:Create("TextButton", {
                        ...
                        TextSize = 14,
                        BackgroundColor3 = FromRGB(16, 18, 21)
                    })  SubItems["Inactive"]:AddToTheme({BackgroundColor3 = "Background"})
                    ...
                    SubItems["Icon"] = Instances:Create("ImageLabel", {
                        Parent = SubItems["Inactive"].Instance,
                        Name = "\0",
                        ImageTransparency = 0.5,
                        BorderColor3 = FromRGB(0, 0, 0),
                        Size = UDim2New(0, 22, 0, 22),
                        AnchorPoint = Vector2New(0, 0.5),
                        Image = "rbxassetid://"..NewSection.Icon,
                        BackgroundTransparency = 1,
                        Position = UDim2New(0, 5, 0.5, 0),
                        ZIndex = 2,
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  SubItems["Icon"]:AddToTheme({ImageColor3 = "Image"})
                    ...
                    NewSection.Items = SubItems

                    local Debounce = false

                    function NewSection:Switch(Bool)
                        if Debounce then 
                            return 
                        end
                        ...
                        SubItems["Content"].Instance.Parent = Bool and Items["Content"].Instance or Library.UnusedHolder.Instance
                        
                        Debounce = true 

                        if Bool then
                            SubItems["Text"].Instance.Visible = true 
                            SubItems["Inactive"]:Tween(nil, {BackgroundTransparency = 0, Size = UDim2New(0, SubItems["Text"].Instance.TextBounds.X + 38, 0, 32)})
                            SubItems["Icon"]:ChangeItemTheme({ImageColor3 = "Accent"})
                            SubItems["Icon"]:Tween(nil, {ImageColor3 = Library.Theme.Accent, ImageTransparency = 0}) 
                        else
                            SubItems["Text"].Instance.Visible = false 
                            SubItems["Inactive"]:Tween(nil, {BackgroundTransparency = 1, Size = UDim2New(0, 25, 0, 32)})
                            SubItems["Icon"]:ChangeItemTheme({ImageColor3 = "Image"})
                            SubItems["Icon"]:Tween(nil, {ImageColor3 = Library.Theme.Image, ImageTransparency = 0.5}) 
                        end
                        ...
                        for Index, Value in Descendants do 
                            ...
                            if type(TransparencyProperty) == "table" then 
                                for _, Property in TransparencyProperty do 
                                    NewTween = Tween:FadeItem(Value, Property, Bool, MultiSection.Window.FadeSpeed)
                                end
                            else
                                NewTween = Tween:FadeItem(Value, TransparencyProperty, Bool, MultiSection.Window.FadeSpeed)
                            end
                        end
                    ...
                    SubItems["Inactive"]:Connect("MouseButton1Down", function()
                        for Index, Value in MultiSection.Sections do 
                            Value:Switch(Value == NewSection)
                        end
                    end)

                    if #MultiSection.Sections == 0 then 
                        NewSection:Switch(true)
                    end
        ...
        Library.Sections.Label = function(self, Text, Alignment, Tooltip)
            ...
            function Label:MultipleKeybind(Data)
                Data = Data or { }
                ...
                local NewKeybind, KeybindItems = Components.MultiKeybind({
                    Name = Keybind.Name,
                    Parent = Items["Label"],
                    Window = Label.Window,
                    Flag = Keybind.Flag,
    ...
    Library.Sections.Divider = function(self, Name)
        local Items = { } do
    ...
    Library.CreateSettingsTab = function(self, Window, Watermark, KeybindList)
        ...
        do -- Settings
            local Subpages = {
                ["Configs"] = SettingsPage:SubPage({
                    Name = "configs", 
                    Icon = "96491224522405", 
                    Columns = 2
                }),

                ["Theming"] = SettingsPage:SubPage({
                    Name = "theming", 
                    Icon = "103863157706913", 
                    Columns = 2
                }),

                ["Configuration"] = SettingsPage:SubPage({
                    Name = "configuration", 
                    Icon = "137300573942266", 
                    Columns = 2
                })
    ...
    do
        ...
        do -- Combat
            ...
            do
                ...
                local Tabbox = Subpages["Aimbot"]:MultiSection({Side = 2})

                local Newtabbox1 = Tabbox:NewSection("section 1", "103174889897193")
                local Newtabbox2 = Tabbox:NewSection("section 2", "103174889897193")
                ...
                do
                    ...
                    GeneralSection:Divider("This is a divider")
                    ...
                    local Textbox = Newtabbox1:Textbox({
                        Name = "Textbox",
                        Flag = "Textbox",
        ...
        do
            Library:CreateSettingsTab(Window, Watermark, KeybindList)
        end
    end
end
